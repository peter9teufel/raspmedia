...
def _optimize(fileName, basePath, destPath, maxW=1920, maxH=1080):
...
def OptimizeImages(files, basePath, destPath, maxW=1920, maxH=1080, isWindows=True):
    ...
    for filename in files:
        _optimize(filename, basePath, destPath, maxW, maxH)
        cnt += 1
